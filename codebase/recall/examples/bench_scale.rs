//! Scale benchmark: every operation at 10k / 50k / 100k entries, with
//! percentile distributions (avg / median / p95 / p99 / min / max), a
//! project/archive mix, and a capture cost breakdown.
//!
//! Run:  cargo run --release --example bench_scale -- [size]
...
//! startup — they isolate the database work.
...
fn main() {
    ...
    println!("Recall scale benchmark (ADR-0025)");
    println!("=============================================");
